...
void configScene() {
 ...
 // Modelos
    ...
    semisphere.initModel("resources/models/semisphere.obj");

 // Imagenes (texturas)
    imgNoEmissive.initTexture    ("resources/textures/imgNoEmissive.png");
    background.initTexture       ("resources/textures/imgBackground2.png");
 ...
 // Materiales
    ...
    texBackground.specular  = imgNoEmissive.getTexture();
    texBackground.emissive  = imgNoEmissive.getTexture();
    texBackground.normal    = 0;
    texBackground.shininess = 1.0;
...
void renderScene() {
 ...
 // Matriz P
    ...
    glm::mat4 P;
    if (camera == 1) {
       P = glm::perspective(glm::radians(fovy1), aspect, nplane, fplane);
    } else if (camera == 2) {
       P = glm::perspective(glm::radians(fovy2), aspect, nplane, fplane);
    } else {
       P = glm::perspective(glm::radians(fovy3), aspect, nplane, fplane);
    }
